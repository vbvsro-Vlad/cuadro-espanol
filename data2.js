...
const database = [
    ...
    { start: 108.7, end: 108.9, es: "Cinco alarmas", ru: "Пять будильников?" },
    { start: 108.9, end: 117, es: "Cinco alarmas estrategicamente programadas para prepararme mentalmente para el momento de levantarme", ru: "Пять будильников, стратегически запрограммированных, чтобы морально подготовить себя к моменту подъёма." },
