...
const database = [
    ...
    { start: 109.8, end: 117, es: "Cinco alarmas estrategicamente programadas para prepararme mentalmente para el momento de levantarme", ru: "Пять будильников, стратегически запрограммированных, чтобы морально подготовить себя к моменту подъёма." },
