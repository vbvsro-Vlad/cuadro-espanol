...
const database = [
    ...
    { start: 50.6, end: 54.6, es: "Serio eres persona de mañanas o persona de noches", ru: "Серьёзно, ты жаворонок или сова? (человек утра или человек ночи?)" },
    { start: 54.6, end: 58.4, es: "Esa pregunta me define completamente", ru: "Этот вопрос определяет меня полностью." },
